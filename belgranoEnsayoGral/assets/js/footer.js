    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-md-0 mb-3 ">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href='https://museoviajero.apsis.com.ar/wp-content/uploads/2020/06/2.-Armar-una-escena-de-t%C3%ADteres.pdf'
                    target="_blank">
                    Armar una escena de títeres</a>   
                    <a href="./assets/img/Armar-una-escena-de-títeres.pdf" download="EscenaBelgrano"><i class="fas fa-cloud-download-alt"></i></a 
                </li>
                <li>
                    <a href="./acrtividad01.html">Completa el PDF</a>   
                    <a href="./assets/img/preguntasBelgrano.pdf" download="ActividadesBelgrano"><i class="fas fa-cloud-download-alt"></i></a>
                </li>
                <li>
                <li>
                    <a href='./assets/img/Pequeña-enciclopedia-de-títeres.pdf'
                    target='_blank'>
                    Ver enciclopedia</a>
                    <a href='./assets/img/Pequeña-enciclopedia-de-títeres.pdf' download="EnciclopediaBelgrano"><i class="fas fa-cloud-download-alt"></i></a>
                </li>
                </li>
                <li>
